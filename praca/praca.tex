...
lub w momencie wywoływania danego elementu (dla metod).

Stworzyliśmy następujące dekoratory:
\begin{itemize}
	\item Dekorator register - dodaje komponent do bibliotki komonentów. Wymaga podania nazwy komponentu,
...
klasy w momencie kompilacji.
	...
	\item Dekorator Attr - dodaje do opisu komponentu, w którym się znajduję, opis samego siebie.
...
\bibitem[hauer]{hauer} Philipp Hauer, \textit{Microservices in a Nutshell. Pros and Cons.},
...
\bibitem[reactlic]{reactlicense} React, etc. Tech Stack, \textit{Your license to use React.js can be revoked if you compete with Facebook},
http://react-etc.net/entry/your-license-to-use-react-js-can-be-revoked-if-you-compete-with-facebook

\bibitem[A2]{angular2} Google, \textit{Angular},
https://angular.io/

\bibitem[React]{react} Facebook, \textit{React},
https://facebook.github.io/react/

\bibitem[Bt]{bootstrap} Twitter, \textit{Bootstrap},
http://getbootstrap.com/

\bibitem[Dj]{django}  Django Software Foundation, \textit{Django},
https://www.djangoproject.com/

\bibitem[Ej]{expressjs} Node.js Foundation, \textit{Express},
https://expressjs.com/

\bibitem[Ws]{wsdl} World Wide Web Consortium, \textit{Web Services Description Language},
https://www.w3.org/TR/wsdl

\bibitem[grpc]{grpc} Google, \textit{gRPC},
http://www.grpc.io/

\bibitem[Play]{play} Lightbend, \textit{Play Framework},
https://www.playframework.com/

\bibitem[SQLite]{sqlite} SQLite Consortium, \textit{SQLite},
https://www.sqlite.org/

\bibitem[postgres]{postgres} The PostgreSQL Global Development Group, \textit{PostgreSQL},
https://www.postgresql.org/

\bibitem[Kazoo]{kazoo} Kazoo team, \textit{Kazoo},
