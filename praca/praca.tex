...
\klasyfikacja{J. Computer Applications\\
...
\includegraphics[width=\textwidth]{../slajdy/Frontend.pdf}
...
\includegraphics[width=\textwidth]{../slajdy/backend.pdf}
...
namiastką ,,Ściany'' znanej z popularnego protalu społecznościowego. Panel z powiadomieniami ([2]), to po prostu dostarczony
...
\begin{tabularx}{\linewidth}{|l|X|} \hline
	...
	Piotr Zalas & Zaproponowanie wstępnej architektury aplikacji.\newline
	  ...
	  Spisanie niniejszej pracy (z wyjątkiem rozdziałów ...).\\
	\hline
\end{tabularx}
