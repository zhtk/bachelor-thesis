...
\begin{tabularx}{\linewidth}{|l|X|} \hline
	...
	Michał Jaroń & Stworzenie architektury warstwy frontend (komponenty). \newline
		Stworzenie mockupów: zwolnienia lekarskiego oraz podglądania kolejek w urzędach. \newline
		Stworzenie front-endu wiadomości. \newline
		Spisanie w pracy rozdziałów 4.2, 4.3, 6.1 - 6.3. \newline
		Implementacja dekoratorów @Attr oraz @Register. \newline
		Projekt i implementacja front-endu Style Guide. \newline
		Projekt edytora. \newline
		Projekt i implementacja komponentów.
	\\	
