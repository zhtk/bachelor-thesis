...
powinno być maksymalnie proste. To pozwala nam stosunkowo małym kosztem podłączać i odłączać kolejne usługi wraz z
...
Rozwój platformy powinien być możliwy także dla słabiej wykształconych lub mniej doświadczonych programistów, których
nie pociągają uroki życia w dużym mieście. W ten sposób nasz projekt realizowałby plan zrównoważonego rozwoju,
zapobiegając zwijaniu się polski lokalnej, a z drugiej strony prowadziłby do wymiernych oszczędności na wynagrodzeniach.
...
WebMethods vs WSO2, vs Talend, Mule vs zato.io, a może bez żadnej szyny usług (single point of failure, szyny lubią się zapychać)? Szyny danych nie zapewniają niezawodności, należy użyć kolejek komunikatów by zapewnić, że raz uruchomiona operacja zostanie przepchnięta przez system. Kolejka może być ukryta wewnątrz mikrousługi, ale wtedy jest problem z atomowością operacji.
Ciekawe wynalazki: DistributedLog, apache kafka
